# Support for reporting issues to console for the Cake.Issues addin for Cake Build Automation System

> **NOTE**:
> This is the version of the addin compatible with [Cake .NET Tool].
> For addin compatible with [Cake Frosting] and [Cake SDK] see [Cake.Frosting.Issues.Reporting.Console](https://www.nuget.org/packages/Cake.Frosting.Issues.Reporting.Console).
