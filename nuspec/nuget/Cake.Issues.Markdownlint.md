...
> For addin compatible with [Cake Frosting] and [Cake SDK] see [Cake.Frosting.Issues.Markdownlint](https://www.nuget.org/packages/Cake.Frosting.Issues.Markdownlint).
