...
The [Cake.Issues.Tap addin](https://cakebuild.net/extensions/cake-issues-tap/) provides the following
features.
...
!!! note
    ...
    The `GenericLogFileFormat` will therefore only return issues containing the description,
    which might be the file name for some tools.
