...
=== "Cake .NET Tool"
    ...
    #addin nuget:?package=Cake.Issues.BuildServer.GitHubActions&version={{ cake_issues_version }}
    ```

    !!! note
        In addition to the GitHub Actions pull request system the `Cake.Issues` and `Cake.Issues.BuildServer` core addins need to be added.
...
=== "Cake SDK"
    ...
    <Project Sdk="Cake.Sdk">
      ...
      <ItemGroup>
        ...
        <PackageReference Include="Cake.Frosting.Issues.BuildServer.GitHubActions" Version="{{ cake_issues_version }}" />
      </ItemGroup>
    </Project>
    ```
...
[GitHubActionsBuilds](https://cakebuild.net/api/Cake.Issues.BuildServer.GitHubActions/GitHubActionsBuildsAliases/)
alias:
