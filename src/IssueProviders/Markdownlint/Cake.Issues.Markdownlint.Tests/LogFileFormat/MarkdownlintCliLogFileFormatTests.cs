...
public sealed class MarkdownlintCliLogFileFormatTests
{
    ...
    public sealed class TheReadIssuesMethod
    {
        ...
        [Fact]
        public void Should_Read_Issue_Correct_0_49_1()
        {
            // Given
            var fixture =
                new MarkdownlintIssuesProviderFixture<MarkdownlintCliLogFileFormat>("markdownlint-cli-0.49.1.log")
                {
                    ReadIssuesSettings = new ReadIssuesSettings("C:/git/github/cake-contrib/Cake.Issues.Markdownlint/tests"),
                };
        ...
        [Fact]
        public void Should_Ignore_NonIssue_Lines()
        {
            // Given
            var fixture =
                new MarkdownlintIssuesProviderFixture<MarkdownlintCliLogFileFormat>("markdownlint-cli-non-issue-line.log")
                {
                    ReadIssuesSettings = new ReadIssuesSettings("C:/git/github/cake-contrib/Cake.Issues.Markdownlint/tests"),
                };
