namespace Cake.Issues.PullRequests
{
    ...
    public static class PullRequestsAliasConstants
    {
        ...
        /// </summary>
        public const string PullRequestSystemCakeAliasCategory = "Pull Request Systems";

        /// <summary>
        /// Category to use for all Cake aliases providing functionality for writing issues to pull requests.
        /// </summary>
        public const string ReportIssuesToPullRequestCakeAliasCategory = "Reporting Issues To Pull Requests";
    }
}
